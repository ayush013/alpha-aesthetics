...
/* harmony import */ var _services_server_interaction_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./services/server-interaction.service */ "./src/app/services/server-interaction.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppComponent = /** @class */ (function () {
    function AppComponent(config, ServerInteractionService) {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.ServerInteractionService.isAuthenticated()
            ...
            if (authenticated) {
                _this.ServerInteractionService.loggedIn = true;
            }
            else {
                _this.ServerInteractionService.loggedIn = false;
            }
        });
    };
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [ng_scrollreveal__WEBPACK_IMPORTED_MODULE_1__["NgsRevealConfig"], _services_server_interaction_service__WEBPACK_IMPORTED_MODULE_2__["ServerInteractionService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _dashboard_calorie_calc_caloriecard_caloriecard_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./dashboard/calorie-calc/caloriecard/caloriecard.component */ "./src/app/dashboard/calorie-calc/caloriecard/caloriecard.component.ts");
/* harmony import */ var _services_local_interaction_service__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./services/local-interaction.service */ "./src/app/services/local-interaction.service.ts");
/* harmony import */ var _services_calorie_calculator_service__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./services/calorie-calculator.service */ "./src/app/services/calorie-calculator.service.ts");
/* harmony import */ var _services_server_interaction_service__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./services/server-interaction.service */ "./src/app/services/server-interaction.service.ts");
/* harmony import */ var _dashboard_calorie_calc_fatloss_fatloss_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./dashboard/calorie-calc/fatloss/fatloss.component */ "./src/app/dashboard/calorie-calc/fatloss/fatloss.component.ts");
/* harmony import */ var _dashboard_calorie_calc_bulking_bulking_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./dashboard/calorie-calc/bulking/bulking.component */ "./src/app/dashboard/calorie-calc/bulking/bulking.component.ts");
/* harmony import */ var _dashboard_calorie_calc_maintain_maintain_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./dashboard/calorie-calc/maintain/maintain.component */ "./src/app/dashboard/calorie-calc/maintain/maintain.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _dashboard_calorie_calc_caloriecard_caloriecard_component__WEBPACK_IMPORTED_MODULE_29__["CaloriecardComponent"],
                _dashboard_calorie_calc_bulking_bulking_component__WEBPACK_IMPORTED_MODULE_34__["BulkingComponent"],
                _dashboard_calorie_calc_maintain_maintain_component__WEBPACK_IMPORTED_MODULE_35__["MaintainComponent"],
                _dashboard_calorie_calc_fatloss_fatloss_component__WEBPACK_IMPORTED_MODULE_33__["FatlossComponent"]
            ],
            imports: [
            ...
            providers: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_27__["AuthGuard"], _services_local_interaction_service__WEBPACK_IMPORTED_MODULE_30__["LocalInteractionService"], _services_calorie_calculator_service__WEBPACK_IMPORTED_MODULE_31__["CalorieCalculatorService"], _services_server_interaction_service__WEBPACK_IMPORTED_MODULE_32__["ServerInteractionService"]],
...
module.exports = "<div class='fabwrapper'>\n    <button class='action-button gradient5 waves-light' mdbWavesEffect><span class='fa fa-plus'></span></button>\n    <ul class='actions'>\n      <li><a class=\"waves-light gradient2\" mdbWavesEffect href=\"https://www.instagram.com/alphaayush\" target=\"_blank\"><span class='fa fa-instagram'></span></a></li>\n      <li><a class=\"waves-light gradient1\" mdbWavesEffect href=\"https://www.facebook.com/alphaayush\" target=\"_blank\"><span class='fa fa-facebook'></span></a></li>\n      <li><a class=\"waves-light gradient6\" mdbWavesEffect href=\"https://www.youtube.com/\" target=\"_blank\"><span class='fa fa-youtube'></span></a></li>\n    </ul>\n  </div>\n  "
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        var typed = new typed_js__WEBPACK_IMPORTED_MODULE_3___default.a("#landingquotes", {
            strings: [
...
/* harmony import */ var _services_server_interaction_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/server-interaction.service */ "./src/app/services/server-interaction.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NavComponent = /** @class */ (function () {
    function NavComponent(renderer, router, LocalInteractionService, ServerInteractionService) {
        var _this = this;
    ...
    NavComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_0__["Renderer2"],
            ...
            _services_local_interaction_service__WEBPACK_IMPORTED_MODULE_2__["LocalInteractionService"],
            _services_server_interaction_service__WEBPACK_IMPORTED_MODULE_3__["ServerInteractionService"]])
    ], NavComponent);
    return NavComponent;
}());
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _server_interaction_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./server-interaction.service */ "./src/app/services/server-interaction.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(ServerInteractionService, router) {
        this.ServerInteractionService = ServerInteractionService;
        this.router = router;
    }
    ...
    AuthGuard = __decorate([
        ...
        __metadata("design:paramtypes", [_server_interaction_service__WEBPACK_IMPORTED_MODULE_2__["ServerInteractionService"], _angular_router__WEBPACK_IMPORTED_MODULE_0__["Router"]])
    ], AuthGuard);
    return AuthGuard;
}());
...
var ServerInteractionService = /** @class */ (function () {
    function ServerInteractionService(http) {
        ...
        this.loggedIn = false;
        this.LoginStatus = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
    }
    ServerInteractionService.prototype.isAuthenticated = function () {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            _this.http.get(_this.apiurl + "/api/authguard")
                .subscribe(function (response) {
                console.log(response);
                if (response.status === 200) {
                    _this.loggedIn = true;
                    _this.LoginStatus.next(_this.loggedIn);
    ...
    ServerInteractionService.prototype.LogOut = function () {
